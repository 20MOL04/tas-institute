...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    badgeEn: "Graduate",
    name: "Diplômé TAS",
    photo: "/images/tas/graduate-duo-man.jpg",
    photoPosition: "50% 30%",
    programFr: "TAS English Institute, Accra",
    programEn: "TAS English Institute, Accra",
    rating: 4,
  ...
  },
  {
    ...
    badgeEn: "Graduate",
    name: "Diplômée TAS",
    photo: "/images/tas/graduate-duo-woman.jpg",
    photoPosition: "50% 30%",
    programFr: "TAS English Institute, Accra",
    programEn: "TAS English Institute, Accra",
    rating: 4,
...
const USED_IN_REVIEWS = new Set(TESTIMONIALS.map((t) => t.photo));
export const HOME_GRADUATES = GRADUATION_PHOTOS.filter((p) => !USED_IN_REVIEWS.has(p.src)).slice(0, 4);
